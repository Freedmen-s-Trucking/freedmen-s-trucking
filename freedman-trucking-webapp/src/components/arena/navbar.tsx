  ...
  return (
    <Navbar fluid rounded>
      ...
      <div className="flex gap-5 md:order-2">
        <button
          type="button"
          className="focus:outline-hidden inline-flex items-center gap-x-2 rounded-3xl border border-gray-800 px-4 py-3 text-sm font-medium text-gray-800 hover:border-gray-500 hover:text-gray-500 focus:border-gray-500 focus:text-gray-500 disabled:pointer-events-none disabled:opacity-50 "
        >
          schedule delivery
        </button>
        {/* <Button outline className="rounded-3xl border">
          Schedule Delivery
        </Button> */}
        <Navbar.Toggle />
      </div>
      <Navbar.Collapse>
        {navigation.map((item) => (
          <Navbar.Link
            href={item.href}
            active={router.location.pathname === item.href}
            className={
