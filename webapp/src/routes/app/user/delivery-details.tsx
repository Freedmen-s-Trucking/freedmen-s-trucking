...
function DeliveryDetailsScreen() {
  ...
  return (
    <div className="min-h-screen bg-white px-6 pt-4">
      ...
      <div className="mb-6">
        <label className="block text-gray-600 mb-2">What are you sending</label>
        <select 
          className="w-full p-4 bg-gray-50 rounded-lg border-0"
          value={packageDetails.itemType}
          onChange={(e) => setPackageDetails({...packageDetails, itemType: e.target.value})}
        >
          <option value="">Select type of item (e.g gadget, document)</option>
      ...
      {/* Select who pays */}
      <div className="mb-6">
        <label className="block text-gray-600 mb-2">Select who pays</label>
        <div className="flex gap-4">
          ...
          <label className="flex items-center">
            ...
            />
            <span className="ml-2">Recipient</span>
          </label>
        </div>
      </div>
      ...
      {/* Recipient Details */}
      <div className="mb-6">
        <label className="block text-gray-600 mb-2">Recipient Name</label>
        <input
          type="text"
          className="w-full p-4 bg-gray-50 rounded-lg border-0"
      ...
      <div className="mb-6">
        <label className="block text-gray-600 mb-2">Recipient contact number</label>
        <input
          type="tel"
          className="w-full p-4 bg-gray-50 rounded-lg border-0"
      ...
      {/* Package Photo */}
      <div className="mb-8">
        <button className="w-full p-6 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center gap-2">
          <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
            <IoCamera className="w-6 h-6 text-gray-400" />
          </div>
          <span className="text-gray-600">Take a picture of the package</span>
        </button>
      </div>
