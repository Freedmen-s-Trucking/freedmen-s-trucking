    ...
    >
      ...
      <motion.div variants={headerVariants} className="mb-8">
        <p className="text-gray-700">
          ...
          the following T&C. If you are a child under 13 years old (or such
          greater age required in your country or territory for you to be
          authorized to register for and use our App without parental approval),
          you are allowed to use our App only after your parent or guardian has
          red and accepted these T&C for you.
        </p>
      </motion.div>
