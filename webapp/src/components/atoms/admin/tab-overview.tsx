...
const Overview: React.FC<{
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-primary-700">System Overview</h2>
      ...
      <div>
        <h3 className="mb-4 text-xl font-bold text-primary-600">Orders</h3>
        <motion.div
      ...
      <div>
        <h3 className="mb-4 text-xl font-bold text-primary-600">Drivers</h3>
        <motion.div
          className="grid grid-cols-1 gap-4 md:grid-cols-3"
          variants={containerVariants}
          initial="hidden"
